...
export const userEditEmail = async (otp: string, email: string) =>
  http.patch<ApiSuccessResponse<string>>("users/me/email", {otp, email}).then((res) => res.data);
...
export const userSendOTP = async (email : string) =>
  http.post<ApiSuccessResponse<string>>("users/me/send-otp", {email}).then((res) => res.data)

export const userVerifyOTP = async (otp : string, email: string) => 
  http.post<ApiSuccessResponse<string>>("users/me/verify-email", {otp, email} ).then((res) => res.data)
