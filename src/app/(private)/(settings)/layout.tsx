    ...
    return (
        <div className="flex">
            <Tabs
                ...
                className="w-[333px] min-h-screen fixed space-y-8 left-0 top-0 md:ml-20 lg:ml-64 h-full flex flex-col lg:border-r px-6 py-12"
            ...
            <div className="flex-1 ml-[450px] w-full xl:ml-100 min-h-screen bg-white dark:bg-neutral-950 mt-12">
                {children}
            </div>
        </div>
    );
