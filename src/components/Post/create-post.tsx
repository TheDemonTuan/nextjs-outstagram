...
import { PostPrivacy, PostResponse, PostType, postCreate, postKey } from "@/api/post";
...
const AddPostModal = ({ onResetModalSelectPhoto }: { onResetModalSelectPhoto: () => void }) => {
  ...
  const isImage = modalData?.selectedFiles?.some((file: File) => file.type.startsWith("image/"))
    ? PostType.DEFAULT
    : PostType.REEL;
                ...
                <ModalBody className="p-0">
                  <div className="flex">
                    <div className="relative overflow-hidden h-[500px] max-w-sm lg:max-w-lg  w-3/5 justify-center items-center flex bg-black">
                      <Carousel slides={slides} type={isImage} />
                    </div>
                    ...
                    <div className="flex flex-col w-2/5">
                      ...
                      <div className="flex items-center justify-between px-4 py-2">
                        ...
                        <span className="bottom-2 right-2 text-xs">
                          {charCount} / {MAX_CHAR}
                        </span>
                      </div>
