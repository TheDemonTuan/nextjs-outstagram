                  ...
                  <Card className="rounded-none shadow-none border-0">
                    ...
                    <CardFooter className="p-2 pb-4 grid gap-1">
                      <div className="flex items-center w-full">
                        ...
                        <Button isIconOnly variant="light" onClick={() => modalOpen(SharedModalKey)}>
                          <MessageCircleIcon className="w-6 h-6 hover:stroke-gray115" stroke="#262626" />
                          <span className="sr-only">Comment</span>
                        </Button>
                        <Button isIconOnly variant="light">
                          <SendIcon className="w-6 h-6 hover:stroke-gray115" stroke="#262626" />
                          <span className="sr-only">Share</span>
                        </Button>
                        <Button className="ml-auto" isIconOnly variant="light">
                          <BookmarkIcon className="w-6 h-6  hover:stroke-gray115" stroke="#262626" />
