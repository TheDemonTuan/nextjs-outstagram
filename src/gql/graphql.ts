...
export type PostByUsernameQuery = {
  ...
  postByUsername: Array<{
    ...
    active: boolean;
    created_at: string;
    post_files?: Array<{ __typename?: "PostFile"; url?: string | null } | null> | null;
  }>;
};
...
export type PostHomePageQuery = {
  ...
  postHomePage: Array<{
    ...
    active: boolean;
    created_at: string;
    user?: { __typename?: "User"; avatar?: string | null; username?: string | null; full_name?: string | null } | null;
    post_files?: Array<{ __typename?: "PostFile"; url?: string | null } | null> | null;
    post_likes?: Array<{ __typename?: "PostLike"; user_id?: string | null; is_liked?: boolean | null } | null> | null;
  }>;
};
...
export type UserSuggestionQuery = {
  __typename?: "Query";
  userSuggestion: Array<{
    __typename?: "UserSuggestion";
    id?: string | null;
    username?: string | null;
    full_name?: string | null;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "is_hide_like" } },
                { kind: "Field", name: { kind: "Name", value: "is_hide_comment" } },
                { kind: "Field", name: { kind: "Name", value: "active" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "post_files" },
                  selectionSet: {
                    kind: "SelectionSet",
...
} as unknown as DocumentNode<PostByUsernameQuery, PostByUsernameQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "PostHomePage" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "post_likes" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "user_id" } },
                      { kind: "Field", name: { kind: "Name", value: "is_liked" } },
                    ],
                  },
                },
                { kind: "Field", name: { kind: "Name", value: "created_at" } },
...
} as unknown as DocumentNode<PostHomePageQuery, PostHomePageQueryVariables>;
...
export const UserSuggestionDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "UserSuggestion" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "count" } },
...
} as unknown as DocumentNode<UserSuggestionQuery, UserSuggestionQueryVariables>;
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "to_user_info" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "id" } },
